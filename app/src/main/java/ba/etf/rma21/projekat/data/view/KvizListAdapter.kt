...
class KvizListAdapter(
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        ...
        }else if(kvizovi[position].datumPocetka.after(Calendar.getInstance().time) && kvizovi[position].datumKraj.after(Calendar.getInstance().time) && kvizovi[position].datumRada == null){
